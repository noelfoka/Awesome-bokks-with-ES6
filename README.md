...
**Awesome Books with ES6** is a basic website that allows users to add/remove books from a list. It was designed using Javascript objects and arrays, dynamically modifying the DOM and adding basic events
